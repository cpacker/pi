...
import type { Api, AssistantMessage, Context, Model, ToolDefinition, Usage } from "../types.ts";
...
export declare function convertResponsesTools(tools: ToolDefinition[], options?: ConvertResponsesToolsOptions): OpenAITool[];
